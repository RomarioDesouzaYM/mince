...
DISTRICTS = [
    ...
    ("Jayawijaya", "Tailarek", -4.1051, 138.7542, 21.8, 1.1, "darat_sulit", "Estimasi awal, belum diverifikasi"),
    ...
    ("Jayawijaya", "Pyramid", -3.8893, 138.7488, 31.7, 1.6, "darat_sulit", "Estimasi awal, belum diverifikasi"),
    ...
    ("Jayawijaya", "Wollo", -3.8696, 138.8838, 25.8, 1.3, "darat_sulit", "Estimasi awal, belum diverifikasi"),
